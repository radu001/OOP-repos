        ...
        <div id="hero-container-map">
            ...
            <div class="search-panel">
                <form class="form-inline" role="form">
                    ...
                    <div class="form-group">
                        <a href="explore.jsp" class="btn btn-green">Search</a>
            ...
            <div class="home-content">
                ...
                <div class="row pb40">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <a href="single.jsp" class="propWidget-2">
                            <div class="fig">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdO7cVCKrLkb5X3orwB0HQl_k7a72MKWGoHrWxstlau958oBgWiYOtRKY7" alt="image">
                                <img class="blur" src="images/prop/1-1.png" alt="image">
                                <div class="opac"></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <a href="single.jsp" class="propWidget-2">
                            <div class="fig">
                                ...
                                <img class="blur" src="images/prop/3-1.png" alt="image">
                                <div class="opac"></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <a href="single.jsp" class="propWidget-2">
                            <div class="fig">
                                ...
                                <img class="blur" src="images/prop/4-1.png" alt="image">
                                <div class="opac"></div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        <a href="single.jsp" class="propWidget-2">
                            <div class="fig">
                                ...
                                <img class="blur" src="images/prop/5-1.png" alt="image">
                                <div class="opac"></div>
                ...
                <div id="home-testimonials" class="carousel slide carousel-wb mb20" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="images/avatar-2.png" class="home-testim-avatar" alt="avatar">
                        ...
                        <div class="item">
                            <img src="images/avatar-1.png" class="home-testim-avatar" alt="avatar">
                            <div class="home-testim">
                                <div class="home-testim-text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words</div>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="signinLable">Sign In</h4>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form">
                            <div class="form-group">
                                <div class="btn-group-justified">
                                    <a href="explore.jsp" class="btn btn-lg btn-facebook"><span class="fa fa-facebook pull-left"></span>Sign Up with Facebook</a>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="btn-group-justified">
                                    <a href="explore.jsp" class="btn btn-lg btn-google"><span class="fa fa-google-plus pull-left"></span>Sign Up with Google</a>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="btn-group-justified">
                                    <a href="explore.jsp" class="btn btn-lg btn-green">Sign Up</a>
                                </div>
                            </div>
